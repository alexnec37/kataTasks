...
namespace nPathFinder1_CanYouReachTheExit_4
{
    public class PathFinder1_CanYouReachTheExit_4
    {
        public static bool PathFinder(string mazePrototip)
        {
        ...
        public static bool WaveLabirint(int[][] maze)
        {
            int n, x = 0, y = 0;
